...
// This test reads the committed BM-3 Cl fixture (tests/fixtures/bm3-cl-trace.json,
// generated by a ~3 h BM-3 run with SOPLO_WRITE_FIXTURES=1; spec 1.3a §2) and
// validates the FFT estimator against zero-crossings on the same trace.
